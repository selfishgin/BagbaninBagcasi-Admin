...
import DebtIcon from "../icons/debt.svg?react";
import OrderHistIcon from "../icons/order-hist.svg?react";
...
const navItems = [
  ...
  },
  {
    ...
    name: "History",
    subItems: [
      { name: "Debt History", path: "/debt-history", pro: false, icon: <DebtIcon className="w-5 h-5" /> },
      { name: "Order History", path: "/order-history", pro: false, icon: <OrderHistIcon className="w-5 h-5" /> },
    ],
  },
];
              ...
              <ul className="mt-2 space-y-1 ml-9">
                {nav.subItems.map((subItem) => (
                  <li key={subItem.name}>
                    <Link
                      to={subItem.path}
                      className={`menu-dropdown-item flex items-center gap-2 ${isActive(subItem.path) ? "menu-dropdown-item-active" : "menu-dropdown-item-inactive"}`}
                    >
                      {subItem.icon && (
